...
extension DateTimeExtention on DateTime {
  ...
  String get dayOfWeekAndDate => '$dayOfWeekString, ${convertToString(pattern: ddMMyyyy)}';
  ...
  /// giờ, ngày
  String get hourAndDateTime => '${convertToString(pattern: HHmm)}, ${convertToString(pattern: ddMMyyyy)}';

  /// ngày, sáng - chiều
  String get dateTimeInTable => '${convertToString(pattern: ddMMyyyy)} - $dateTimeToVnHour';

  /// thứ(số), ngày tháng năm, giờ
  String get dateTimeInWeather => '$dayOfWeekNumber, ${convertToString(pattern: ddMMyyyy)}';
  ...
  /// ngày - giờ
  String get dateTimeString => '${convertToString(pattern: ddMMyyyy)} - ${convertToString(pattern: HHmm)}';

  /// thứ(số), ngày tháng
  String get dateTimeToWeekdayAndDayMonth => '$dayOfWeekNumber, ${convertToString(pattern: ddMM)}';
  ...
  DateTime convertNewFormatDate({required String newPattern, required String currentPattern}) =>
  ...
  String get dateTimeToVnHour =>
      convertToString(pattern: HHmma).replaceAll("PM", "chiều").replaceAll("AM", "sáng");

  String get toUtcString => toUtc().toIso8601String();

  String get toUtcServer => DateFormat("yyyy-MM-dd'T'HH:mm:ss.SSS'Z'").format(toLocal());
