...
class _BodyIntroCourseV2Comp extends State<AniAppBarTitle> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    _colorTween = ColorTween(
        begin: Colors.teal.withOpacity(0.1), end:  Colors.teal)
            ...
            builder: (context, child) => AppBar(
              ...
              title: Opacity(
                ...
                child: Text(
                  'This is title for example very very long long long long long long',
                  maxLines: 1,
                  style: appStyle.textTheme.headline1?.apply(color: Colors.black),
    ...
    if (index == 0) {
      return Padding(
        ...
        child: Text(
          ...
          style: appStyle.textTheme.bodyText2?.copyWith(color: Colors.black, height: 1.5),
