...
class AvatarComp extends StatefulWidget {
  ...
  const AvatarComp(this.fullName, {this.image, this.width = 40, this.radius, this.color, Key? key})
      : super(key: key);
                  ...
                  child: Center(
                    child: !systemIsEmpty(_image)
                        ...
                        : Text(
                            _first.toUpperCase(),
                            style: TextStyle(
                                fontSize: _fontSize, fontWeight: FontWeight.w600, color: Colors.white),
                          ),
                  ),
                ),
          )),
