...
import 'package:achitecture_weup/common/core/widget/button/floating_action_button_comp.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButtonComp(
          child: const Icon(CupertinoIcons.add), onPressed: onPressedFAB),
      bottomNavigationBar:
          BottomAppBarComp(onChangeTab: (int value) => onChangeTab.call(value)),
    );
  }
}
...
class BottomAppBarComp extends StatefulWidget {
  ...
  const BottomAppBarComp({Key? key, required this.onChangeTab})
      : super(key: key);
