...
import 'image/image_viewer_comp.dart';
...
class _FormAlbumState extends State<FormAlbum> {
              ...
              child: SizedBox(
                ...
                child: ListView(
                  ...
                  children: List<Widget>.generate(
                      ...
                      (index) => _LayoutImage(
                            child:
                                ImageViewer('${_items[index]['path']}', fit: BoxFit.fill, hasViewImage: true),
                            hasMargin: _items[index]['isLast'] != null && _items[index]['isLast'] == 1
                                ? false
                                : true,
                            isRoot: false,
                            onDelete: _onDelete,
  ...
  void _onViewMore(List items) =>
      Navigator.of(context).push(MaterialPageRoute(builder: (context) => ViewImage(ImageData(urls: []))));
