...
class InterceptorMemory extends InterceptorBase {
  InterceptorMemory({int? maxAgeSecond, bool? forceReplace}) : super(forceReplace: forceReplace, maxAgeSecond: maxAgeSecond);
  ...
  void onResponse(Response response, ResponseInterceptorHandler handler) {
    ...
    CacheManagerFactory(RequestCacheManager()).put(CacheModel(
